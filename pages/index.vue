...
const { data } = await useFetch<string, ResData>('/users/1', {
  pick: ['id', 'name', 'email'],
...
<template>
  <div class="bg-white pb-6 sm:pb-8 lg:pb-12">
    <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
      ...
      <main class="mt-16">
        ...
        >
          ...
          >
            <a
              href="#"
              class="group w-full md:w-32 lg:w-48 h-48 md:h-full block self-start flex-shrink-0 bg-gray-100 overflow-hidden relative"
            >
              <img
      ...
      <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto mt-20">
        <div
        ...
        >
          ...
          <div class="flex gap-4">
            ...
            <a
              href="https://github.com/kira-0521"
              target="_blank"
              class="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100"
            >
              <svg
        ...
        <div class="text-gray-400 text-sm text-center py-8">
          © 2021 - Kira Tanaka. All rights reserved.
        </div>
      </footer>
    </div>
  </div>
